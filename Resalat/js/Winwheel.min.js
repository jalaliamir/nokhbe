function Winwheel(a, c) {
    var junction_font = new FontFace('YekanBakh_Medium', 'url(fonts/fonts/IRAN_Sans_Regular.woff)');
    ...
    defaultOptions = {
        ...
        drawMode: "code",
        rotationAngle: 0,
        textFontFamily: "YekanBakh_Medium",
        textFontSize: 12,
        textFontWeight: "bold",
        ...
        if (this.segments)
            for (var b = 1; b <= this.numSegments; b++) {
                ...
                if (d.imgData.height) {
                    ...
                    if ("S" == h) { h = a - e / 2; var n = c; var r = d.startAngle + 180 + (d.endAngle - d.startAngle) / 2 } else "E" == h ? (h = a, n = c - t / 2, r = d.startAngle + 270 + (d.endAngle -
...
Winwheel.prototype.windowToCanvas = function(a, c) { var b = this.canvas.getBoundingClientRect(); return { x: Math.floor(a - this.canvas.width / b.width * b.left), y: Math.floor(c - this.canvas.height / b.height * b.top) } };
...
Winwheel.prototype.getSegmentNumberAt = function(a, c) {
    ...
    for (e = 1; e <= this.numSegments; e++)
        if (b >= this.segments[e].startAngle && b <= this.segments[e].endAngle && n >= h && n <= t) { d = e; break }
    return d
};
...
Winwheel.prototype.getIndicatedSegmentNumber = function() {
    ...
    for (var b = 1; b < this.segments.length; b++)
        if (c >= this.segments[b].startAngle && c <= this.segments[b].endAngle) { a = b; break }
    return a
};
...
function winwheelStopAnimation(a) { 0 != a && (a = winwheelToDrawDuringAnimation.animation.callbackFinished, null != a && ("function" === typeof a ? a(winwheelToDrawDuringAnimation.getIndicatedSegment()) : eval(a))) }
